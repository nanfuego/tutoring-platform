    ...
    <div className="public-home">
      <header className="public-nav">
        <div className="public-nav-inner">
          <a href="#top" className="public-brand" aria-label="LJG Home">
            <img src={logo} alt="LJG Student Management" />
          </a>
          ...
          <div className="public-hero-inner">
            <div className="public-hero-copy">
              ...
              <p className="public-hero-lead">
                Professional student assistance and virtual office support
                for busy students, families, and small teams who need
                dependable help managing everyday administrative work.
              </p>
              ...
              <div className="hero-visual-window">
                ...
                <div className="hero-window-body">
                  <div className="hero-mini-sidebar">
                    <div className="hero-mini-logo">LJG</div>
        ...
        <section className="public-intro" id="about">
          <div className="public-section-inner public-intro-grid">
            ...
            <div className="public-intro-copy">
              <p>
                LJG provides hands-on administrative and student support for
                people who need an extra set of reliable hands. The goal is
                simple: keep records organized, communication clear, tasks
                moving, and important details from falling through the cracks.
              </p>

              <p>
                Support can be tailored to ongoing needs, whether that means
                assisting students, organizing office work, tracking progress,
                managing schedules, or helping with recurring administrative
                responsibilities.
              </p>
            </div>
          </div>
        ...
        <section className="public-services" id="services">
          <div className="public-section-inner">
            <div className="public-section-heading">
              ...
              <p>
                Flexible administrative assistance designed around the tasks
        ...
        <section className="public-benefits">
          <div className="public-section-inner public-benefits-grid">
            <div className="public-benefits-copy">
              <span className="public-eyebrow">WHY WORK WITH LJG</span>
            ...
            <div className="public-contact-card">
              <div>
                ...
                <p>
                  ...
                  or help managing recurring administrative work, LJG can help
                  build a workflow that fits your needs.
                </p>
              </div>

              <div className="public-contact-actions">
                <a href="mailto:your-email@example.com" className="public-button primary light">
                  Send an Email
                </a>

                <span className="public-contact-note">
                  Replace the email address with Joyce's business email.
                </span>
              </div>
            </div>
          </div>
      ...
      <footer className="public-footer">
        <div className="public-section-inner public-footer-inner">
          <div>
            <img src={logo} alt="LJG" />
            <p>Student assistance and administrative support.</p>
          </div>
